...
public class JedisUtil { 
     ...
     static {  
            ...
            //redis未设置了密码：
           String host = PropertiesUtil.getValue("redis.properties", "redis.hosts");
           String port =PropertiesUtil.getValue("redis.properties", "redis.port");
           String password =PropertiesUtil.getValue("redis.properties", "redis.password");

           jedisPool = new JedisPool(config,host, Integer.parseInt(port), 10000, password);
