 ...
 * 获取token请求实体
 */
public class GetApiTokenRequestEntity {
	...
	public GetApiTokenRequestEntity() {
		super();
		// TODO Auto-generated constructor stub
	}
	public GetApiTokenRequestEntity(String func, String username, String password, String api_name, String api_secret,
			String safecode) {
		super();
		this.func = func;
