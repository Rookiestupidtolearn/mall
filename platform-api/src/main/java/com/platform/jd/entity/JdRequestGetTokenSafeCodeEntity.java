 ...
 *
 */
public class JdRequestGetTokenSafeCodeEntity {
	...
	public JdRequestGetTokenSafeCodeEntity() {
		super();
		// TODO Auto-generated constructor stub
	}
	public JdRequestGetTokenSafeCodeEntity(String func, String username, String password, String api_name,
			String api_secret) {
		super();
		this.func = func;
