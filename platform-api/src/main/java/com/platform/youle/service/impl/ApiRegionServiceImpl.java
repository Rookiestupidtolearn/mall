...
public class ApiRegionServiceImpl extends AbsApiRegionService{
	...
	@Override
	protected ResponseBaseEntity<ResponseRegionEntity> province() {
        ...
        try {
            ...
            logger.info("[4.1获取一级地址-省份] 返回结果："+JSONObject.toJSONString(entity));
	...
	@Override
	protected ResponseBaseEntity<ResponseRegionEntity> city(int province) {
		ResponseBaseEntity<ResponseRegionEntity> response =null;
        ...
        try {
            ...
            logger.info("[4.2获取二地址-城市] 返回结果："+JSONObject.toJSONString(entity));
            response = JSON.parseObject(result,ResponseBaseEntity.class);
        } catch (Exception e) {
	...
	@Override
	protected ResponseBaseEntity<ResponseRegionEntity> county(int city) {
		ResponseBaseEntity<ResponseRegionEntity> response =null;
        ...
        try {
            ...
            logger.info("[4.3获取三级地址-县/区] 返回结果："+JSONObject.toJSONString(entity));
            response = JSON.parseObject(result,ResponseBaseEntity.class);
        } catch (Exception e) {
	...
	@Override
	protected ResponseBaseEntity<ResponseRegionEntity> town(int county) {
		ResponseBaseEntity<ResponseRegionEntity> response =null;
        ...
        try {
            ...
            logger.info("[4.4获取四级地址-镇/街道] 返回结果："+JSONObject.toJSONString(entity));
            response = JSON.parseObject(result,ResponseBaseEntity.class);
        } catch (Exception e) {
